...
//    setting, update this list in the same change — the diff makes it reviewable.
{
	const EXPECTED_KEYS = [
		...
		"cardMaxChars", "closeupMode", "clusterOffsets",
		"clusterSpacing", "drosteFocus", "encoding",
		"gapFinder", "ghostEdgeMinJaccard", "globalAggregationAttribute",
		"heatmapCriterion", "heatmapJaccard",
		...
		"latticeNodeLOD", "latticeShowSubsetLinks", "latticeSpecificTop", "layerAggregation", "layerInheritFull", "legendHiddenModes", "legendPos", "lensPresets",
		"maxNeighborhoodSize", "minFontPx", "nodeCols",
		"nodeDisplayOverrides", "nodeOffsets", "nodeRows", "nodeSpacing", "noteMenuVisible",
		"panelVisible", "panoramaMode", "perspective",
		"showBody", "showEdges", "showEnclosures", "showGhostEdges", "showGrid", "showLegend",
		"showMaturity", "showNodes", "staleDays",
		"upsetColumnSort", "upsetMinColumnSize", "viewMode",

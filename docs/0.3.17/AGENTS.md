# AGENTS.md — Tag Lens v0.3.17 (required reading, authoritative)
...
2. **`src/view.ts` is a ~5200-line god-file.** Line numbers drift constantly; re-anchor with `grep -n` before editing.
   The split is in `docs/0.3.17/refactor-view-split.md` (Tier 1–3 done, Tier 4 = drawing, deferred).
...
## 5. References
- Design: `docs/0.3.17/basic-design.md`, `docs/0.3.17/detailed-design.md`
- In progress: `docs/0.3.17/refactor-view-split.md` (view.ts split)
- Handoff: `docs/0.3.17/handoff-droste-axis.md` (Icon Gallery custom-axis Cartesian)

...
(view.ts is now ~4800 lines), confirming the split approach is safe and effective.
...
- 6512 lines → core view.ts ~3500 lines + several <1000-line modules (Tier 1–3 already moved ~1700 lines out).
...
- Note: this versioned design doc is tracked under `docs/0.3.12/`; superseded notes live in `docs/old/`.
